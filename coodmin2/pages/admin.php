...
<div id="bids" class="container-row text-center">
    <div class="row"><!--
        if ($bidNotVerify['image']!= null) {
                echo '<img class="img-responsive " src="../img/'. $bidNotVerify['id'] . '/' . $bidNotVerify['image'] .'" alt="'. $bidNotVerify['title'] .'">';
            }else{
                echo '<img class="img-responsive " src="../img/bids/'. $bidNotVerify['category'] . '.jpg" alt="'. $bidNotVerify['title'] .'">';
            }-->
        <?php
        ...
        foreach ($bidsNotVerify as $bidNotVerify) {
            ...
            echo '<h2><a href="bid.php?id='. $bidNotVerify['id'] .'">'. $bidNotVerify['title'] .'</a></h2>';
            echo '</div>';
